      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="<?php echo base_url('application/views/home/overview.php') ?>">Home
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('application/views/about/overview.php') ?>">About</a>
          </li>
          <li class="nav-item">
...
<form class="form-inline my-0 my-sm-0 mr-auto">
